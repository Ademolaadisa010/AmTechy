    ...
    <div className="w-full min-h-screen font-sans antialiased bg-white text-gray-900">
      ...
      <section id="tracks" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <motion.div 
          ...
          className="bg-gradient-to-br from-[#1e40af] to-[#7c3aed] rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition p-8 flex flex-col items-center justify-center text-center text-white">
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        ...
        className="bg-gradient-to-br from-pink-50 to-pink-100 p-8 rounded-2xl">
